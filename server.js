...
app.get("/:room",(req,res)=>{//:room is like a parameter.
...
io.on('connection',socket=>{
    socket.on('join-room',(roomId,userId)=>{//userId refers to the person who joined and it is called from the peer connections
        ...
        socket.on('message',message=>{//this will listen the message
...
server.listen(process.env.PORT||4999,()=>{//process.env.PORT-this will work when you are in heroku server
